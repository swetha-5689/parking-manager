...
const port = process.env.PORT || 7000; // port that the server will be on
...
mongoose.connect(
  uri,
  { useNewUrlParser: true, useCreateIndex: true, useUnifiedTopology: true } // uri = where our database is stored
);
